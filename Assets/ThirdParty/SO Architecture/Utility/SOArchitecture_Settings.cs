...
namespace DanielEverland.ScriptableObjectArchitecture.Utility
{
    public class SOArchitecture_Settings : ScriptableObject
    {
        ...
        [SerializeField]
        private readonly bool _drawEventGizmos = true;
        [SerializeField]
        private readonly string _codeGenerationTargetDirectory = "CODE_GENERATION";
        [SerializeField, Tooltip("Allow newly generated code files to overwrite existing ones")]
        private readonly bool _codeGenerationAllowOverwrite = false;
        [SerializeField]
        private readonly int _defualtCreateAssetMenuOrder = 120;
    }
}